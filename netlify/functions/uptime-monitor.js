...
const BINARY_URLS = {
  mac_arm:   'https://github.com/LexSort-Inc/LexSort-Vera-Personal-AI/releases/download/v1.1.11/LexSort.VERA_1.1.11_aarch64.dmg',
  mac_intel: 'https://github.com/LexSort-Inc/LexSort-Vera-Personal-AI/releases/download/v1.1.6/LexSort.Personal.AI_1.1.6_x64.dmg',
  ...
  linux_app: 'https://github.com/LexSort-Inc/LexSort-Vera-Personal-AI/releases/download/v1.1.11/LexSort.VERA_1.1.11_amd64.AppImage',
  linux_deb: 'https://github.com/LexSort-Inc/LexSort-Vera-Personal-AI/releases/download/v1.1.11/LexSort.VERA_1.1.11_amd64.deb'
};
